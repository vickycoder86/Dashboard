...
const SideBar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-[230px] overflow-y-auto text-center bg-black text-white ${
      ...
      >
        ...
        >
          ...
          <span className="text-[15px] ml-4 text-white">Home</span>
        </div>
        ...
        >
          ...
          <span className="text-[15px] ml-4 text-white">Customers</span>
        </div>
        ...
        >
          ...
          <span className="text-[15px] ml-4">Companies</span>
        </div>

        <div
          className="flex text-[18px] gap-16"
          style={{ position: "absolute", bottom: "2%", paddingLeft: "13px" }}
        >
          <i className="bi bi-gear text-white" title="Setting"></i>
          <i
            className="bi-brightness-high cursor-pointer"
            title="Change Mode coming soon.." // Toggle theme
          ></i>
          <i
