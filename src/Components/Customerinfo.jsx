...
const Customerinfo = ({ closePopup, isopen }) => {
  ...
  const[invoicesLimit,setInvoicesLimit]=useState(location.state.invoiceslimit)
  const[companieslimit,setcompanieslimit]=useState(location.state.companieslimit)
  ...
  const UpdateCompanyData = ({ id,name, gstno, industry, created_at,payment_alert_date,freeze_date,terminate_date,orderbook_enabled}) => (
    ...
    <>
      ...
      <div className="w-full max-w-sm h-[290px]  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-[240px]">
        ...
        <div className="flex flex-col items-center pb-10">
          ...
          <div className="flex">
            ...
            <div className="mb-1 px-2 text-md  text-gray-900 dark:text-white">
              {custId}
            </div>
          </div>
          <div className="flex">
          ...
          <div className="flex gap-2">
            <div className="font-medium">Installation Price:</div>
            <h5 className="mb-1 text-md  text-gray-900 dark:text-white">
              &#8377;{installPrice}
            </h5>
            <div className="font-medium">Renewal Price:</div>
          ...
          <div className="flex gap-2 py-1">
            ...
            <div className="font-medium text-red-600 ml-4">Compaines Limit:</div>
            <div className="mb-1 text-md  text-gray-900 dark:text-white">
              {companieslimit}
            </div>
          </div>
      ...
      {showCompainesdata ? (
        ...
        {/* this is for company list */}
          <h1 className="ml-[240px] text-center text-blue-800 font-bold">Company List</h1>
      ...
      >
        {isSidebarVisibleCompany ? <i class="bi bi-arrow-right-circle-fill text-[#00A0E3]"></i> : <i class="bi bi-layout-sidebar-inset-reverse   text-[#00A0E3]"></i>}
      </button>
      ...
      >
        {isSidebarVisibleCompany && (
            ...
            <label>
              <input
               className="mr-2"
                ...
                onChange={() => handleCheckboxChangeCompany("terminate_date")}
              />
              Terminate Date
            </label>
            <br />
            <label>
              <input
               className="mr-2"
                ...
                onChange={() => handleCheckboxChangeCompany("orderbook_enabled")}
              />
              Orderbook
            </label>
          </>
          ...
          <h1 className="ml-[240px] text-center text-blue-800 font-bold">Users List</h1>
      ...
      >
        {isSidebarVisibleUsers ? <i class="bi bi-arrow-right-circle-fill text-[#00A0E3]"></i> : <i class="bi bi-layout-sidebar-inset-reverse   text-[#00A0E3]"></i>}
      </button>
          ...
          <>
            ...
            <label>
              <input
                ...
                onChange={() => handleCheckboxChange("logged_in_devices_count")}
              />
              Logged In(Device)
            </label>
          </>
